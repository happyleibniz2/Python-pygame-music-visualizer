...
# --- UI Layout Update: Two columns, compact, add GENRE button ---
BUTTON_WIDTH = 110
BUTTON_HEIGHT = 30
BUTTON_MARGIN = 8
BUTTON_COLS = 2
...
SLIDER_RECT = pygame.Rect(10 + BUTTON_WIDTH + BUTTON_MARGIN, 10 + (BUTTON_HEIGHT + BUTTON_MARGIN) * 3, BUTTON_WIDTH, 10)
    ...
    if data is not None:
        ...
        if idx + 2048 < len(data):
            ...
            if "Breakcore" in genre_fx:
                ...
                #if on_beat and random.random() < 0.08:
                #    flash_surf = pygame.Surface((WIDTH, HEIGHT), pygame.SRCALPHA)
                #    flash_surf.fill(random.choice(breakcore_palette) + (120,))
                #    screen.blit(flash_surf, (0,0), special_flags=pygame.BLEND_RGB_ADD)
